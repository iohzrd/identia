...
inResponseTo(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
inResponseTo(optionalEncoding?:any):string|Uint8Array|null {
...
static addInResponseTo(builder:flatbuffers.Builder, inResponseToOffset:flatbuffers.Offset) {
  builder.addFieldOffset(2, inResponseToOffset, 0);
}
...
static createComment(builder:flatbuffers.Builder, bodyOffset:flatbuffers.Offset, cidOffset:flatbuffers.Offset, inResponseToOffset:flatbuffers.Offset):flatbuffers.Offset {
  Comment.startComment(builder);
  Comment.addBody(builder, bodyOffset);
  Comment.addCid(builder, cidOffset);
  Comment.addInResponseTo(builder, inResponseToOffset);
